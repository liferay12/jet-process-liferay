package io.jetprocess.docs.dto.v1_0;
...
@Generated("")
@GraphQLName(
	description = "Contains all files for the receipt.", value = "DOCStore"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DOCStore")
public class DOCStore implements Serializable {

	public static DOCStore toDTO(String json) {
		return ObjectMapperUtil.readValue(DOCStore.class, json);
	}

	public static DOCStore unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(DOCStore.class, json);
	}
	...
	@Schema(description = "The DOCStore id")
	public Long getId() {
		return id;
	}
	...
	@GraphQLField(description = "The DOCStore id")
	...
	public String toString() {
		...
		if (documentStream != null) {
			...
			sb.append(_escape(documentStream));
	...
	@Schema(
		...
		defaultValue = "io.jetprocess.docs.dto.v1_0.DOCStore",
		name = "x-class-name"
	)
