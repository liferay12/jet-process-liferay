...
/**
 * Provides the local service interface for UserPost. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserPostLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserPostLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>io.jetprocess.masterdata.service.impl.UserPostLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user post local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserPostLocalServiceUtil} if injection and service tracking are not available.
	 */
