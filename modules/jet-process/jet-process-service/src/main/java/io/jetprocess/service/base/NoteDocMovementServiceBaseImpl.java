...
import io.jetprocess.service.NoteDocMovementService;
import io.jetprocess.service.NoteDocMovementServiceUtil;
...
/**
 * Provides the base implementation for the note doc movement remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.NoteDocMovementServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.NoteDocMovementServiceImpl
 * @generated
 */
public abstract class NoteDocMovementServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NoteDocMovementService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NoteDocMovementService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>NoteDocMovementServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NoteDocMovementService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		noteDocMovementService = (NoteDocMovementService)aopProxy;

		_setServiceUtilService(noteDocMovementService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return NoteDocMovementService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = NoteDocMovementServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, noteDocMovementService);
		}
	...
	@Reference
	protected io.jetprocess.service.NoteDocMovementLocalService
		noteDocMovementLocalService;

	protected NoteDocMovementService noteDocMovementService;
