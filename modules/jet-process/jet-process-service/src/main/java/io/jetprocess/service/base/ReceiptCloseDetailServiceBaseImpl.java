...
import io.jetprocess.service.ReceiptCloseDetailService;
...
/**
 * Provides the base implementation for the receipt close detail remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.ReceiptCloseDetailServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.ReceiptCloseDetailServiceImpl
 * @generated
 */
public abstract class ReceiptCloseDetailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ReceiptCloseDetailService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReceiptCloseDetailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ReceiptCloseDetailServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ReceiptCloseDetailService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		receiptCloseDetailService = (ReceiptCloseDetailService)aopProxy;

		_setServiceUtilService(receiptCloseDetailService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ReceiptCloseDetailService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ReceiptCloseDetailServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, receiptCloseDetailService);
		}
	...
	@Reference
	protected io.jetprocess.service.ReceiptCloseDetailLocalService
		receiptCloseDetailLocalService;

	protected ReceiptCloseDetailService receiptCloseDetailService;
