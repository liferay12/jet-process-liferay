...
/**
 * Provides the base implementation for the file note remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.FileNoteServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.FileNoteServiceImpl
 * @generated
 */
public abstract class FileNoteServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FileNoteService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FileNoteService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FileNoteServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FileNoteService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fileNoteService = (FileNoteService)aopProxy;

		_setServiceUtilService(fileNoteService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FileNoteService.class.getName();
	}
	...
	private void _setServiceUtilService(FileNoteService fileNoteService) {
		try {
			Field field = FileNoteServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, fileNoteService);
		}
	...
	@Reference
	protected io.jetprocess.service.FileNoteLocalService fileNoteLocalService;

	protected FileNoteService fileNoteService;
