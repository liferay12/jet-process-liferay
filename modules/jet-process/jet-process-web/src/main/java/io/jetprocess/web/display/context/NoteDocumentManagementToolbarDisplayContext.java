...
public class NoteDocumentManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

	public NoteDocumentManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest,
	...
	public String getSearchActionURL() {
		...
		searchURL.setParameter("mvcRenderCommandName", MVCCommandNames.CREATED_LIST_NOTE_DOCUMENT_RENDER_COMMAND);
	...
	private PortletURL _getCurrentSortingURL() throws PortletException {
		...
		sortingURL.setParameter("mvcRenderCommandName", MVCCommandNames.CREATED_LIST_NOTE_DOCUMENT_RENDER_COMMAND);
