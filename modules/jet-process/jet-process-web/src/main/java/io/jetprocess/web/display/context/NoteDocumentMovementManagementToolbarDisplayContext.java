...
public class NoteDocumentMovementManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext{

	public NoteDocumentMovementManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest,
	...
	protected String getOrderByCol() {
		return ParamUtil.getString(request, "orderByCol", "createOn");
	}
	...
	public String getSearchActionURL() {
		...
		searchURL.setParameter("mvcRenderCommandName", MVCCommandNames.NOTE_DOCUMENT_MOVEMENT_LIST_RENDER_COMMAND);
		...
		return new DropdownItemList() {
			{
				add(dropdownItem ->{
					...
					dropdownItem.setLabel(LanguageUtil.get(request, "noteDocumentNumber" , "NoteDocument Number"));
				});
				add(dropdownItem ->{
					dropdownItem.setActive("closedOn".equals(getOrderByCol()));
					dropdownItem.setHref(_getCurrentSortingURL(),"orderByCol", "createOn" );
					dropdownItem.setLabel(LanguageUtil.get(request, "createOn" , "Create On"));
				});
			}
		};
	}
	...
	private PortletURL _getCurrentSortingURL() throws PortletException {
		...
		sortingURL.setParameter("mvcRenderCommandName", MVCCommandNames.NOTE_DOCUMENT_MOVEMENT_LIST_RENDER_COMMAND);
