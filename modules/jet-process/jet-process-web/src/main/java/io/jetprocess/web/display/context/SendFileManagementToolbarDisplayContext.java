...
public class SendFileManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

	public SendFileManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest,
