...
public class AddCorrespondenceManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

	public AddCorrespondenceManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest,
