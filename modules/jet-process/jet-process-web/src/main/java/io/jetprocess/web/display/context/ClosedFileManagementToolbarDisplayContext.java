...
public class ClosedFileManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext{

	public ClosedFileManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest,
