...
public class PutInFileManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

	public PutInFileManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest,
	...
	public String getSearchActionURL() {
		...
		searchURL.setParameter("mvcRenderCommandName", MVCCommandNames.PUTINFILE_RENDER_COMMAND);
	...
	private PortletURL _getCurrentSortingURL() throws PortletException {
		...
		sortingURL.setParameter("mvcRenderCommandName", MVCCommandNames.PUTINFILE_RENDER_COMMAND);
