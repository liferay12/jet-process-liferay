...
@Component(immediate = true, property = { "javax.portlet.name=" + JetProcessWebPortletKeys.JETPROCESSWEB,
		"mvc.command.name=" + MVCCommandNames.Corr_RECEIPT_CLOSE_RENDER_COMMAND }, service = MVCRenderCommand.class)
public class CorrespondenceCloseRendererCommand implements MVCRenderCommand {
	@Override
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		return "/file/correspondence-close.jsp";
	}
}
