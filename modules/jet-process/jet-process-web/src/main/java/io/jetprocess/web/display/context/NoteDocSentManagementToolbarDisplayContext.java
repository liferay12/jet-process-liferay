...
public class NoteDocSentManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

	public NoteDocSentManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest,
	...
	public String getSearchActionURL() {
		...
		searchURL.setParameter("mvcRenderCommandName", MVCCommandNames.SEND_LIST_NOTE_DOCUMENT_RENDER_COMMAND);
	...
	private PortletURL _getCurrentSortingURL() throws PortletException {
		...
		sortingURL.setParameter("mvcRenderCommandName", MVCCommandNames.SEND_LIST_NOTE_DOCUMENT_RENDER_COMMAND);
