...
@Component(immediate = true, property = { "javax.portlet.name=" + JetProcessWebPortletKeys.JETPROCESSWEB,
		"mvc.command.name=" + MVCCommandNames.Corr_RECEIPT_REOPEN_RENDER_COMMAND }, service = MVCRenderCommand.class)
public class CorrespondenceReopenRendererCommand implements MVCRenderCommand {
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		return "/file/correspondence-reopen.jsp";
	}
}
