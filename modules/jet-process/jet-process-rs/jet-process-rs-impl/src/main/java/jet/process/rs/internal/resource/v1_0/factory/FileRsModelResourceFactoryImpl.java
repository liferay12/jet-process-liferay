...
public class FileRsModelResourceFactoryImpl
	...
	public FileRsModelResource.Builder create() {
		return new FileRsModelResource.Builder() {
			...
			public FileRsModelResource build() {
				...
				return _fileRsModelResourceProxyProviderFunction.apply(
	...
	private static Function<InvocationHandler, FileRsModelResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			FileRsModelResource.class.getClassLoader(),
			FileRsModelResource.class);

		try {
			Constructor<FileRsModelResource> constructor =
				(Constructor<FileRsModelResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, FileRsModelResource>
		_fileRsModelResourceProxyProviderFunction = _getProxyProviderFunction();
