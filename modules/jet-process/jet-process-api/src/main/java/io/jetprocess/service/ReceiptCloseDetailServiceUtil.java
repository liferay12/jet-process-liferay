 ...
 * @generated
 */
public class ReceiptCloseDetailServiceUtil {
	...
	public static ReceiptCloseDetailService getService() {
		return _service;
	}

	private static volatile ReceiptCloseDetailService _service;
