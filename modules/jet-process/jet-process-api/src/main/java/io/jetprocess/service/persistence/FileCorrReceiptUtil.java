...
/**
 * The persistence utility for the file corr receipt service. This utility wraps <code>io.jetprocess.service.persistence.impl.FileCorrReceiptPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FileCorrReceiptPersistence
 * @generated
 */
public class FileCorrReceiptUtil {
	 ...
	 */
	public static void clearCache(FileCorrReceipt fileCorrReceipt) {
		getPersistence().clearCache(fileCorrReceipt);
	}
	 ...
	 */
	public static Map<Serializable, FileCorrReceipt> fetchByPrimaryKeys(
	 ...
	 */
	public static List<FileCorrReceipt> findWithDynamicQuery(
	 ...
	 */
	public static FileCorrReceipt update(FileCorrReceipt fileCorrReceipt) {
		return getPersistence().update(fileCorrReceipt);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static FileCorrReceipt update(
		FileCorrReceipt fileCorrReceipt, ServiceContext serviceContext) {

		return getPersistence().update(fileCorrReceipt, serviceContext);
	}
	 ...
	 */
	public static List<FileCorrReceipt> findByUuid(String uuid) {
	 ...
	 */
	public static List<FileCorrReceipt> findByUuid(
	 ...
	 */
	public static FileCorrReceipt findByUuid_First(
	 ...
	 */
	public static FileCorrReceipt fetchByUuid_First(
		String uuid, OrderByComparator<FileCorrReceipt> orderByComparator) {
	 ...
	 * @throws NoSuchFileCorrReceiptException if a matching file corr receipt could not be found
	 */
	public static FileCorrReceipt findByUuid_Last(
			String uuid, OrderByComparator<FileCorrReceipt> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {
	 ...
	 */
	public static FileCorrReceipt fetchByUuid_Last(
		String uuid, OrderByComparator<FileCorrReceipt> orderByComparator) {
	 ...
	 */
	public static FileCorrReceipt[] findByUuid_PrevAndNext(
			long fileCorrReceiptId, String uuid,
			OrderByComparator<FileCorrReceipt> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {

		return getPersistence().findByUuid_PrevAndNext(
			fileCorrReceiptId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchFileCorrReceiptException if a matching file corr receipt could not be found
	 */
	public static FileCorrReceipt findByUUID_G(String uuid, long groupId)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {
	 ...
	 */
	public static FileCorrReceipt fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching file corr receipt, or <code>null</code> if a matching file corr receipt could not be found
	 */
	public static FileCorrReceipt fetchByUUID_G(
	 ...
	 */
	public static FileCorrReceipt removeByUUID_G(String uuid, long groupId)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {
	 ...
	 * @return the matching file corr receipts
	 */
	public static List<FileCorrReceipt> findByUuid_C(
	 ...
	 * @throws NoSuchFileCorrReceiptException if a matching file corr receipt could not be found
	 */
	public static FileCorrReceipt findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<FileCorrReceipt> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {
	 ...
	 * @return the first matching file corr receipt, or <code>null</code> if a matching file corr receipt could not be found
	 */
	public static FileCorrReceipt fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<FileCorrReceipt> orderByComparator) {
	 ...
	 * @throws NoSuchFileCorrReceiptException if a matching file corr receipt could not be found
	 */
	public static FileCorrReceipt findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<FileCorrReceipt> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {
	 ...
	 * @return the last matching file corr receipt, or <code>null</code> if a matching file corr receipt could not be found
	 */
	public static FileCorrReceipt fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<FileCorrReceipt> orderByComparator) {
	 ...
	 * @throws NoSuchFileCorrReceiptException if a file corr receipt with the primary key could not be found
	 */
	public static FileCorrReceipt[] findByUuid_C_PrevAndNext(
			long fileCorrReceiptId, String uuid, long companyId,
			OrderByComparator<FileCorrReceipt> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {

		return getPersistence().findByUuid_C_PrevAndNext(
			fileCorrReceiptId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @throws NoSuchFileCorrReceiptException if a matching file corr receipt could not be found
	 */
	public static FileCorrReceipt findByFileCorrReceipt(
			long receiptId, long receiptMovementId)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {

		return getPersistence().findByFileCorrReceipt(
	 ...
	 * @return the matching file corr receipt, or <code>null</code> if a matching file corr receipt could not be found
	 */
	public static FileCorrReceipt fetchByFileCorrReceipt(
		long receiptId, long receiptMovementId) {

		return getPersistence().fetchByFileCorrReceipt(
			receiptId, receiptMovementId);
	}
	...
	public static FileCorrReceipt fetchByFileCorrReceipt(
		...
		return getPersistence().fetchByFileCorrReceipt(
			receiptId, receiptMovementId, useFinderCache);
	}
	 ...
	 * @return the file corr receipt that was removed
	 */
	public static FileCorrReceipt removeByFileCorrReceipt(
			long receiptId, long receiptMovementId)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {

		return getPersistence().removeByFileCorrReceipt(
			receiptId, receiptMovementId);
	}
	 ...
	 * @return the number of matching file corr receipts
	 */
	public static int countByFileCorrReceipt(
		long receiptId, long receiptMovementId) {

		return getPersistence().countByFileCorrReceipt(
			receiptId, receiptMovementId);
	}
	 ...
	 */
	public static void cacheResult(FileCorrReceipt fileCorrReceipt) {
		getPersistence().cacheResult(fileCorrReceipt);
	}
	 ...
	 */
	public static void cacheResult(List<FileCorrReceipt> fileCorrReceipts) {
		getPersistence().cacheResult(fileCorrReceipts);
	}
	 ...
	 */
	public static FileCorrReceipt create(long fileCorrReceiptId) {
		return getPersistence().create(fileCorrReceiptId);
	}
	 ...
	 * @throws NoSuchFileCorrReceiptException if a file corr receipt with the primary key could not be found
	 */
	public static FileCorrReceipt remove(long fileCorrReceiptId)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {

		return getPersistence().remove(fileCorrReceiptId);
	}

	public static FileCorrReceipt updateImpl(FileCorrReceipt fileCorrReceipt) {
		return getPersistence().updateImpl(fileCorrReceipt);
	}
	 ...
	 * @throws NoSuchFileCorrReceiptException if a file corr receipt with the primary key could not be found
	 */
	public static FileCorrReceipt findByPrimaryKey(long fileCorrReceiptId)
		throws io.jetprocess.exception.NoSuchFileCorrReceiptException {

		return getPersistence().findByPrimaryKey(fileCorrReceiptId);
	}
	 ...
	 */
	public static FileCorrReceipt fetchByPrimaryKey(long fileCorrReceiptId) {
		return getPersistence().fetchByPrimaryKey(fileCorrReceiptId);
	}
	 ...
	 */
	public static List<FileCorrReceipt> findAll() {
	 ...
	 */
	public static List<FileCorrReceipt> findAll(int start, int end) {
	...
	public static FileCorrReceiptPersistence getPersistence() {
		return _persistence;
	}

	private static volatile FileCorrReceiptPersistence _persistence;
