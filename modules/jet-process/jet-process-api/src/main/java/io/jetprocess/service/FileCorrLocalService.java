...
/**
 * Provides the local service interface for FileCorr. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FileCorrLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FileCorrLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>io.jetprocess.service.impl.FileCorrLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the file corr local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FileCorrLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FileCorr addFileCorr(FileCorr fileCorr);
	...
	public FileCorr createFileCorr(long fileCorrId);
	...
	public FileCorr deleteFileCorr(FileCorr fileCorr);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FileCorr deleteFileCorr(long fileCorrId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FileCorr fetchFileCorr(long fileCorrId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FileCorr fetchFileCorrByUuidAndGroupId(String uuid, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FileCorr getFileCorr(long fileCorrId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FileCorr getFileCorrByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FileCorr> getFileCorrs(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FileCorr> getFileCorrsByUuidAndCompanyId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FileCorr updateFileCorr(FileCorr fileCorr);
