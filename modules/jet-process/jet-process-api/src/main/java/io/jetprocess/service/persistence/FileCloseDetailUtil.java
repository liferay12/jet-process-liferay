...
/**
 * The persistence utility for the file close detail service. This utility wraps <code>io.jetprocess.service.persistence.impl.FileCloseDetailPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FileCloseDetailPersistence
 * @generated
 */
public class FileCloseDetailUtil {
	 ...
	 */
	public static void clearCache(FileCloseDetail fileCloseDetail) {
		getPersistence().clearCache(fileCloseDetail);
	}
	 ...
	 */
	public static Map<Serializable, FileCloseDetail> fetchByPrimaryKeys(
	 ...
	 */
	public static List<FileCloseDetail> findWithDynamicQuery(
	 ...
	 */
	public static FileCloseDetail update(FileCloseDetail fileCloseDetail) {
		return getPersistence().update(fileCloseDetail);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static FileCloseDetail update(
		FileCloseDetail fileCloseDetail, ServiceContext serviceContext) {

		return getPersistence().update(fileCloseDetail, serviceContext);
	}
	 ...
	 */
	public static List<FileCloseDetail> findByUuid(String uuid) {
	 ...
	 */
	public static List<FileCloseDetail> findByUuid(
	 ...
	 */
	public static FileCloseDetail findByUuid_First(
			String uuid, OrderByComparator<FileCloseDetail> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCloseDetailException {
	 ...
	 */
	public static FileCloseDetail fetchByUuid_First(
		String uuid, OrderByComparator<FileCloseDetail> orderByComparator) {
	 ...
	 * @throws NoSuchFileCloseDetailException if a matching file close detail could not be found
	 */
	public static FileCloseDetail findByUuid_Last(
			String uuid, OrderByComparator<FileCloseDetail> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCloseDetailException {
	 ...
	 */
	public static FileCloseDetail fetchByUuid_Last(
		String uuid, OrderByComparator<FileCloseDetail> orderByComparator) {
	 ...
	 */
	public static FileCloseDetail[] findByUuid_PrevAndNext(
			long fileClosedId, String uuid,
			OrderByComparator<FileCloseDetail> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCloseDetailException {

		return getPersistence().findByUuid_PrevAndNext(
			fileClosedId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchFileCloseDetailException if a matching file close detail could not be found
	 */
	public static FileCloseDetail findByUUID_G(String uuid, long groupId)
		throws io.jetprocess.exception.NoSuchFileCloseDetailException {
	 ...
	 */
	public static FileCloseDetail fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching file close detail, or <code>null</code> if a matching file close detail could not be found
	 */
	public static FileCloseDetail fetchByUUID_G(
	 ...
	 */
	public static FileCloseDetail removeByUUID_G(String uuid, long groupId)
		throws io.jetprocess.exception.NoSuchFileCloseDetailException {
	 ...
	 * @return the matching file close details
	 */
	public static List<FileCloseDetail> findByUuid_C(
	 ...
	 * @throws NoSuchFileCloseDetailException if a matching file close detail could not be found
	 */
	public static FileCloseDetail findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<FileCloseDetail> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCloseDetailException {
	 ...
	 * @return the first matching file close detail, or <code>null</code> if a matching file close detail could not be found
	 */
	public static FileCloseDetail fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<FileCloseDetail> orderByComparator) {
	 ...
	 * @throws NoSuchFileCloseDetailException if a matching file close detail could not be found
	 */
	public static FileCloseDetail findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<FileCloseDetail> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCloseDetailException {
	 ...
	 * @return the last matching file close detail, or <code>null</code> if a matching file close detail could not be found
	 */
	public static FileCloseDetail fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<FileCloseDetail> orderByComparator) {
	 ...
	 * @throws NoSuchFileCloseDetailException if a file close detail with the primary key could not be found
	 */
	public static FileCloseDetail[] findByUuid_C_PrevAndNext(
			long fileClosedId, String uuid, long companyId,
			OrderByComparator<FileCloseDetail> orderByComparator)
		throws io.jetprocess.exception.NoSuchFileCloseDetailException {

		return getPersistence().findByUuid_C_PrevAndNext(
			fileClosedId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(FileCloseDetail fileCloseDetail) {
		getPersistence().cacheResult(fileCloseDetail);
	}
	 ...
	 */
	public static void cacheResult(List<FileCloseDetail> fileCloseDetails) {
		getPersistence().cacheResult(fileCloseDetails);
	}
	 ...
	 */
	public static FileCloseDetail create(long fileClosedId) {
		return getPersistence().create(fileClosedId);
	}
	 ...
	 * @throws NoSuchFileCloseDetailException if a file close detail with the primary key could not be found
	 */
	public static FileCloseDetail remove(long fileClosedId)
		throws io.jetprocess.exception.NoSuchFileCloseDetailException {

		return getPersistence().remove(fileClosedId);
	}

	public static FileCloseDetail updateImpl(FileCloseDetail fileCloseDetail) {
		return getPersistence().updateImpl(fileCloseDetail);
	}
	 ...
	 * @throws NoSuchFileCloseDetailException if a file close detail with the primary key could not be found
	 */
	public static FileCloseDetail findByPrimaryKey(long fileClosedId)
		throws io.jetprocess.exception.NoSuchFileCloseDetailException {

		return getPersistence().findByPrimaryKey(fileClosedId);
	}
	 ...
	 */
	public static FileCloseDetail fetchByPrimaryKey(long fileClosedId) {
		return getPersistence().fetchByPrimaryKey(fileClosedId);
	}
	 ...
	 */
	public static List<FileCloseDetail> findAll() {
	 ...
	 */
	public static List<FileCloseDetail> findAll(int start, int end) {
	...
	public static FileCloseDetailPersistence getPersistence() {
		return _persistence;
	}

	private static volatile FileCloseDetailPersistence _persistence;
